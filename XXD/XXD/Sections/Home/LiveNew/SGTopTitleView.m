...
#define selectedTitleAndIndicatorViewColor [UIColor colorWithRed:16/255.0 green:134/255.0 blue:243/255.0 alpha:1.0]
...
- (void)setScrollTitleArr:(NSArray *)scrollTitleArr {
    ...
    for (NSUInteger i = 0; i < self.scrollTitleArr.count; i++) {
        ...
        _scrollTitleLabel.font = [UIFont systemFontOfSize:15.0];
...
- (void)scrollTitleLabelSelecteded:(UILabel *)label {
    ...
    // 改变指示器位置
    [UIView animateWithDuration:0.20 animations:^{
        self.indicatorView.SG_width = _scrollTitleLabel.SG_width;
        self.indicatorView.SG_centerX = label.SG_centerX;
    }];
}
